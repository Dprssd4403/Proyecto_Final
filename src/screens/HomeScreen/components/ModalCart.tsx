...
export const ModalCart = ({ visible, setShowModal, cart, setCart }: Props) => {
  ...
  const handleClearCart = () => {
    ...
    //cerrar modal
    setShowModal();
     Alert.alert("Gracias por su compra","Compra realizada");
      return;
  };
        ...
        <View style={{ ...styles.modal, width: width * 0.8 }}>
          ...
          <View style={localStyles.headerTable}>
            ...
            <View style={localStyles.headerTableInfo}>
              <Text
                style={{ ...localStyles.textHeaderTable,marginHorizontal: 10 }}
              >
                Pre.
              </Text>
              <Text style={{ ...localStyles.textHeaderTable, marginHorizontal: 10 }}>Cant.</Text>
              <Text
                style={{ ...localStyles.textHeaderTable, marginHorizontal: 10 }}
              >
                Total
          ...
          <View style={localStyles.containerTotalPay}>
            <Text style={localStyles.textTotalPay}>
              Total pagar: ${totalPay().toFixed(1)}
            </Text>
          </View>
          <TouchableOpacity
